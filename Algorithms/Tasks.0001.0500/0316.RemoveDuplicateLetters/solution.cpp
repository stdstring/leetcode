...
{
public:
    [[nodiscard]] std::string removeDuplicateLetters(std::string const &s) const
    {
        // preparation
...
namespace RemoveDuplicateLettersTask
{

TEST(RemoveDuplicateLettersTaskTests, Examples)
{
    const Solution solution;
    ASSERT_EQ("abc", solution.removeDuplicateLetters("bcabc"));
    ASSERT_EQ("acdb", solution.removeDuplicateLetters("cbacdcbc"));
}

TEST(RemoveDuplicateLettersTaskTests, FromWrongAnswers)
{
    const Solution solution;
    ASSERT_EQ("abc", solution.removeDuplicateLetters("abacb"));
}
